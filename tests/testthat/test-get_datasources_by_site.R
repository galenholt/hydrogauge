test_that("states datasources by site", {
  with_mock_dir('mocked_responses/get_datasources_by_site/vic',
  vds <- get_datasources_by_site(portal = 'vic', site_list = "233217")
  )
  with_mock_dir('mocked_responses/get_datasources_by_site/qld',
  qds <- get_datasources_by_site(portal = 'qld', site_list = "422211A")
  )
  with_mock_dir('mocked_responses/get_datasources_by_site/nsw',
