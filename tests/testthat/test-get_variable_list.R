test_that("returns expected", {
  with_mock_dir('mocks/get_variable_list/simple',
...
test_that("handles missing", {
  ...
  with_mock_dir('mocks/get_variable_list/missing',
  ...
  with_mock_dir('mocks/get_variable_list/missing_and_exist',
...
test_that("lake level and other", {
  ...
  with_mock_dir('mocks/get_variable_list/lake_level',
