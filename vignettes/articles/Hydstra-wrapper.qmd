...
I'll use the same set of sites as in the [core hydstra demonstration](hydstra_traces_workflow.qmd), chosen to capture a range of periods of records and available variables.
