---
title: "BOM quality codes"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{bom_quality_codes}
...
-   130
    -   zero-rainfall
    -   The record set has no measurement recorded over the period the aggregated total is calculated.
